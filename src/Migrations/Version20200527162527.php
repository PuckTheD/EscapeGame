 ...
 */
final class Version20200527162527 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE scenario_team_inventaire (scenario_team_id INT NOT NULL, inventaire_id INT NOT NULL, INDEX IDX_E44C3054CE430A85 (inventaire_id), INDEX IDX_E44C305436AA18AE (scenario_team_id), PRIMARY KEY(scenario_team_id, inventaire_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE scenario_team_progression (scenario_team_id INT NOT NULL, progression_id INT NOT NULL, INDEX IDX_1969E2F6AF229C18 (progression_id), INDEX IDX_1969E2F636AA18AE (scenario_team_id), PRIMARY KEY(scenario_team_id, progression_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
